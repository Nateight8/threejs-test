...
export function Wing(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/models/wing/scene.gltf") as GLTFResult;
  return (
...
useGLTF.preload("/models/wing/scene.gltf");
